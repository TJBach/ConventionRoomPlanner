    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            prod:{
                files: [
                    {
                        src: ['lib/jquery/jquery-1.9.1.min.js', 'lib/jquery-ui/js/jquery-ui-1.10.3.custom.min.js', 'lib/bootstrap/js/bootstrap.min.js', 'lib/knockout/knockout-2.3.0.js', 'lib/knockout/knockout-deferred-updates.min.js', 'lib/lodash/lodash.min.js'],
            ...
            dev: {
                files: [
                    {
                        src: ['lib/jquery/jquery-1.9.1.js', 'lib/jquery-ui/js/jquery-ui-1.10.3.custom.js', 'lib/bootstrap/js/bootstrap.js', 'lib/knockout/knockout-2.3.0.debug.js', 'lib/knockout/knockout-deferred-updates.js', 'lib/lodash/lodash.js'],
